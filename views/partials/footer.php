...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-5">
        ...
        <li class="list-inline-item"><a href="https://www.instagram.com/iprveda/"><svg
      ...
      <div class="col-12 col-md-3">
        ...
        <ul class="list-unstyled">
          <li><a href="trademark">Trademark Registeration</a></li>
  ...
  <div class="container py-4 py-lg-5">
    ...
    <div class="text-muted d-flex justify-content-between align-items-center pt-3">
      <p class="mb-0 muted small">IPR VEDA&nbsp;© Copyright 2024. All Rights Reserved. 
     </p>
      <p class="mb-0 muted small ">X27 Experiments Technologies Private Limited 
     </p>
